...
export async function proxy(request: NextRequest) {
  ...
  response.headers.set(
    ...
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.google.com https://www.gstatic.com https://www.googletagmanager.com https://googleads.g.doubleclick.net https://analytics.google.com https://chatbot.hindleconsultants.com; style-src 'self' 'unsafe-inline' https://chatbot.hindleconsultants.com; img-src 'self' data: https: blob:; font-src 'self' data: https://chatbot.hindleconsultants.com; connect-src 'self' https://*.supabase.co https://www.google.com https://www.googletagmanager.com https://googleads.g.doubleclick.net https://analytics.google.com https://chatbot.hindleconsultants.com; frame-src 'self' https://www.google.com https://www.googletagmanager.com https://chatbot.hindleconsultants.com; child-src 'self' https://chatbot.hindleconsultants.com; object-src 'none'; base-uri 'self'; form-action 'self';",
  )
