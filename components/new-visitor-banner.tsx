      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            ...
            <span className="ml-2 text-sm opacity-90">Get your AR automation platform configured at no cost</span>
          </div>
          <div className="md:hidden">
            <div className="text-sm font-bold">Free Setup for September!</div>
            <div className="text-xs opacity-90">AR automation platform setup</div>
          </div>
        </div>
