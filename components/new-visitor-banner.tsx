      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-4 flex-1">
          <div className="flex items-center gap-2">
            ...
            <span className="bg-red-500 text-white px-2 py-1 rounded-full text-xs font-semibold">SEPTEMBER ONLY</span>
          </div>
        ...
        <div className="flex items-center gap-3">
          <Link href="/demo">
            <Button size="sm" className="bg-white text-cyan-600 hover:bg-gray-100 font-semibold">
              Schedule Demo Now
            </Button>
          </Link>

          <button onClick={handleClose} className="text-white hover:text-gray-200 p-1" aria-label="Close banner">
            <X className="h-5 w-5" />
          </button>
        </div>
      </div>
