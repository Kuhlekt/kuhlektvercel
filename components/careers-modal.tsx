      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          <div className="text-gray-600">
            <p className="mb-4">
              At Kuhlekt, we're revolutionizing how businesses manage their accounts receivable. We're always looking
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              We're not currently hiring, but we're always interested in hearing from talented professionals who are
              passionate about fintech and AR automation.
            </p>
          ...
          <div className="text-center">
            <p className="text-gray-600 mb-4">Interested in future opportunities? We'd love to hear from you.</p>
            <Button variant="outline" className="border-cyan-600 text-cyan-600 hover:bg-cyan-50 bg-transparent">
              Get in Touch
            </Button>
          </div>
