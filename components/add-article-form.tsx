...
export function AddArticleForm({ categories, onAddArticle, onCancel, currentUser }: AddArticleFormProps) {
  ...
  const canPublish = currentUser && (currentUser.role === "admin" || currentUser.role === "editor")
