      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="mt-4 space-y-2">
          ...
          <div className="p-3 bg-yellow-50 rounded-lg border">
            <p className="text-sm text-yellow-800 font-medium">Login Issues?</p>
            <p className="text-xs text-yellow-700 mt-1">
              Open browser console (F12) to see login debug info, or click below to reset.
            </p>
            <Button
              type="button"
              variant="outline"
              ...
              onClick={() => {
                if (confirm("Reset admin user and clear all data?")) {
                  localStorage.clear()
