      ...
      <section className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
            Schedule a demo to see how Kuhlekt can help your finance team get
            paid faster with our advanced AR Automation and Digital Collections
            solutions.
          </p>
          <Link href="/demo#top">
            <Button
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>
                  <Link
                    href="/product#digital-collections"
                    className="hover:text-gray-900"
                  >
                    Digital Collections
                  </Link>
                ...
                <li>
                  <Link
                    href="/product#dispute-management"
                    className="hover:text-gray-900"
                  >
                    Dispute Management
                  </Link>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li>
                  <Link
                    href="/solutions#sme-credit-management"
                    className="hover:text-gray-900"
                  >
                ...
                <li>
                  <Link
                    href="/solutions#enterprise-receivables"
                    className="hover:text-gray-900"
                  >
                ...
                <li>
                  <Link
                    href="/solutions#corporate-debt-collection"
                    className="hover:text-gray-900"
                  >
                ...
                <li>
                  <Link
                    href="/solutions#credit-control-software"
                    className="hover:text-gray-900"
                  >
