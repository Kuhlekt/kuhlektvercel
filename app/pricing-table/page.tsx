...
export default function PricingTablePage() {
  ...
  const features = [
    ...
    {
      name: "Kuhlekt collection management platform",
      bronze: true,
      silver: true,
      gold: true,
      platinum: true,
    ...
    {
      name: "Multiple dunning procedures",
      bronze: true,
      silver: true,
      gold: true,
      platinum: true,
    ...
    {
      name: "Dispute workflow management",
      bronze: true,
      silver: true,
      gold: true,
      platinum: true,
    ...
    {
      name: "Immediate or Bulk statements",
      bronze: true,
      silver: true,
      gold: true,
      platinum: true,
    ...
    {
      name: "AI quick Action templates",
      bronze: true,
      silver: true,
      gold: true,
      platinum: true,
    ...
    {
      name: "Download transactions CSV",
      bronze: false,
      silver: true,
      gold: true,
      platinum: true,
      ...
      <main className="pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex items-center justify-center gap-4 mb-8">
              <span
                className={`font-medium ${
                  currency === "AUD" ? "text-gray-500" : "text-gray-900"
                }`}
              >
                AUD
              </span>
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setCurrency(checked ? "USD" : "AUD")
                }
                className="data-[state=checked]:bg-cyan-500"
              />
              <span
                className={`font-medium ${
                  currency === "USD" ? "text-gray-500" : "text-gray-900"
                }`}
              >
                USD
              </span>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">
                    {editMode ? (
                      <Input
                        value={
                          currency === "USD"
                            ? pricingData.bronze.usd
                            : pricingData.bronze.aud
                        }
                        onChange={(e) =>
                          updatePricingData(
                            "bronze",
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">
                    {editMode ? (
                      <Input
                        value={
                          currency === "USD"
                            ? pricingData.silver.usd
                            : pricingData.silver.aud
                        }
                        onChange={(e) =>
                          updatePricingData(
                            "silver",
                  ...
                  <div className="text-3xl font-bold text-gray-900 mb-1">
                    {editMode ? (
                      <Input
                        value={
                          currency === "USD"
                            ? pricingData.gold.usd
                            : pricingData.gold.aud
                        }
                        onChange={(e) =>
                          updatePricingData(
                            "gold",
                  ...
                  <div className="text-2xl font-bold text-gray-900 mb-1">
                    {editMode ? (
                      <Input
                        ...
                        onChange={(e) =>
                          updatePricingData("platinum", "price", e.target.value)
                        }
              ...
              <div className="p-4 text-center border-l">
                {editMode ? (
                  <Input
                    value={
                      currency === "USD"
                        ? pricingData.bronze.setupFeeUsd
                        : pricingData.bronze.setupFeeAud
                    }
                    onChange={(e) =>
                      updatePricingData(
                        "bronze",
              ...
              <div className="p-4 text-center border-l">
                {editMode ? (
                  <Input
                    value={
                      currency === "USD"
                        ? pricingData.silver.setupFeeUsd
                        : pricingData.silver.setupFeeAud
                    }
                    onChange={(e) =>
                      updatePricingData(
                        "silver",
              ...
              <div className="p-4 text-center border-l">
                {editMode ? (
                  <Input
                    value={
                      currency === "USD"
                        ? pricingData.gold.setupFeeUsd
                        : pricingData.gold.setupFeeAud
                    }
                    onChange={(e) =>
                      updatePricingData(
                        "gold",
              ...
              <div className="p-4 text-center border-l">
                {editMode ? (
                  <Input
                    ...
                    onChange={(e) =>
                      updatePricingData("platinum", "setupFee", e.target.value)
                    }
                    className="text-center"
                  />
                ) : (
            ...
            <div className="divide-y divide-gray-200">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="hidden md:grid md:grid-cols-5 hover:bg-gray-50"
                >
                  <div
                    className={`p-4 font-medium text-gray-900 ${
                      feature.name.includes("Setup") ||
                      feature.name.includes("Scheduled") ||
                      feature.name.includes("Ad hoc") ||
                      feature.name.includes("Reminders") ||
                      feature.name.includes("Payments") ||
                      feature.name.includes("Direct Debits") ||
                      feature.name.includes("Download") ||
                      feature.name.includes("Dispute") ||
                      feature.name.includes("Invoice") ||
                      feature.name.includes("Statement")
                        ? "pl-8 text-sm"
                        : ""
                    }`}
                  >
              ...
              {selectedTab === "platinum" && (
                <div className="p-6">
                  <div className="text-center mb-6">
                    ...
                    <div className="mt-4 text-sm text-gray-600">
                      Setup fee: {pricingData.platinum.setupFee}
                    </div>
                  </div>
                  <div className="space-y-3">
                    {features.map((feature, index) => (
          ...
          <div className="mt-8 text-sm text-gray-600 space-y-2">
            <p>
              <strong>**</strong> Copies received via email BCC from ERP
              alternate options available by quote.
            </p>
            <p>
              <strong>***</strong> Based on Stripe other providers quoted. Fees
              to client accounts.
            </p>
            <p>
              <strong>****</strong> Additional Regional Onboarding @ $140 PCM
              each in currency selected table.
            </p>
            <p>
              <strong>Core</strong> Users defined as Finance, Collections staff,
              Collection Managers, CFO, Accountants.
            </p>
            <p>
            ...
            <p>
              All figures in selected currency and exempt of any Taxes, Duties
              and or fees.
            </p>
