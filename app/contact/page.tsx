...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section id="top" className="bg-gradient-to-br from-slate-50 to-blue-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Badge className="bg-cyan-100 text-cyan-700 px-4 py-2 rounded-full mb-6">Get in Touch</Badge>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Ready to transform your accounts receivable process? Our team is here to help you get started and answer any
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="mt-12 space-y-4">
                <h3 className="text-xl font-semibold text-gray-900">Prefer to talk?</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-6">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  Most customers are up and running within 1-2 weeks. Our implementation team will work with you and we
                  answer any questions to ensure a smooth transition.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="p-6">
              <CardContent className="p-0">
                <h3 className="font-semibold text-lg mb-3">Do you integrate with our ERP?</h3>
                <p className="text-gray-600">
                  Yes! We integrate with all major ERP systems including SAP, Oracle, NetSuite, QuickBooks, and many
                  others.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="p-6">
              <CardContent className="p-0">
                <h3 className="font-semibold text-lg mb-3">What kind of support do you provide?</h3>
                <p className="text-gray-600">
                  We offer 24/7 support via phone, email, and chat. Plus dedicated customer success managers for
