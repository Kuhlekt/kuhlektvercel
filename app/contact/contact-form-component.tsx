              ...
              <Card className="shadow-xl">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900">Proven Results</h4>
                      <p className="text-sm text-gray-600">Average 35% reduction in DSO within 90 days</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Go live in as little as 2 weeks</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
