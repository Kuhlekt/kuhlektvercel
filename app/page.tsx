                ...
                <Card className="absolute top-6 right-6 w-64 bg-white shadow-xl z-20 border-0">
                  <CardContent className="p-4">
                    ...
                    <blockquote className="text-sm text-gray-700 mb-4 italic leading-relaxed">
                      "Kuhlekt transformed our accounts receivable process. We reduced DSO by 30% and our team now
                      spends 80% less time on manual collections. The ROI was immediate and substantial."
                    </blockquote>
                    <div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    "Kuhlekt has revolutionized our collections process. We've seen a 40% improvement in collection
                    rates and our team is much more efficient."
                  </p>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    "Implementation was smooth and the results were immediate. Kuhlekt has become an essential part of
