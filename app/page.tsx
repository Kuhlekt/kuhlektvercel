  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600">
                  Accelerate collections with automated follow-ups, payment reminders, and intelligent prioritization to
                  get paid faster.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600">
                  Eliminate time-consuming manual tasks with automated workflows, smart routing, and AI-powered decision
                  making.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600">
                  Proactively identify at-risk accounts with predictive analytics and take action before problems
                  escalate.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Everything you need to automate AR</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From invoice processing to collections management, Kuhlekt provides a complete platform for accounts
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Streamline invoice creation, delivery, and tracking with intelligent automation that reduces
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Engage customers through multiple channels with personalized communication strategies that improve
                      payment rates.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Get deep insights into your AR performance with real-time dashboards and predictive analytics that
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Trusted by finance teams worldwide</h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-500 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">Ready to transform your AR process?</h2>
