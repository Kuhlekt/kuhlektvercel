...
export const metadata: Metadata = {
  title: "About Us - Kuhlekt",
  description:
    "Learn about Kuhlekt's mission to help finance teams get paid faster with less stress through automated accounts receivable management.",
}
