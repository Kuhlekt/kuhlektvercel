      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Trusted by 0000's+ finance team members
          </p>
        </div>
      </section>
      ...
      <section id="enterprise-receivables" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card
              className="p-8 hover:shadow-lg transition-shadow bg-white"
              id="sme-credit-management"
            >
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-6">
                  Tools designed for lean finance teams to manage credit limits,
                  automate AR, and reduce risk.
                </p>
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-500 flex-shrink-0" />
                    <span className="text-gray-700">
                      Automated collections for small teams
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-500 flex-shrink-0" />
            ...
            <Card className="p-8 hover:shadow-lg transition-shadow bg-white">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-6">
                  Scalable workflows for large, distributed teams with complex
            ...
            >
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-6">
                  Systematically automate collection sequences with smart
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-cyan-500 flex-shrink-0" />
                    <span className="text-gray-700">
                      Legal integration for severe cases
                    </span>
                  </div>
                </div>
              </CardContent>
            ...
            >
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-6">
                  Centralize all your credit control activities—from approvals
                  to overdue escalations.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Tailored for different business sizes and complexity levels
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Solutions that grow with your business, from SME to enterprise
                scale
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Built by finance professionals who understand your challenges
              </p>
            </div>
